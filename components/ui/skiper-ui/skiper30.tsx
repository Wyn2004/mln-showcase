...
const Skiper30 = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 text-slate-900 dark:text-slate-100">
      <div className="font-geist flex h-screen items-center justify-center">
        <div className="absolute left-1/2 top-[15%] -translate-x-1/2 text-center space-y-6 max-w-4xl px-4">
          ...
          <div className="flex flex-col items-center space-y-2 mt-8">
            ...
            <div className="w-px h-16 bg-gradient-to-b from-red-500 to-red-600"></div>
          </div>
        </div>
      </div>
      ...
      <div
        ref={gallery}
        className="relative box-border flex h-[175vh] gap-[2vw] overflow-hidden bg-white dark:bg-slate-800 p-[2vw]"
      >
